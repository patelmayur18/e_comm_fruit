"""
Django settings for Health_cart project.
...
SECRET_KEY = '@ny^#nk9gqbxjqb$t-7#5mk%q*ki5pery9y+_mf^efp@g%5rj5'
...
WSGI_APPLICATION = 'Health_cart.wsgi.application'
